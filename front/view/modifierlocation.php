...
$location = $locationc->getLocation($idlocation);
        ...
        if ($datedebut > $date) {
            if ($_POST['date_fin'] > $_POST['date_debut']) {
                if (strlen($_POST['numero']) == 8) {
                    ...
                    $part = $locationc->modifierlocation($location, $idlocation);
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <form action="modifierlocation.php?idlocation=<?php echo $_GET["idlocation"] ?>" method="post">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4">
                                                <input type="date" class="form-control" name="date_debut" value="<?php echo $location['date_debut']; ?>"></input>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4">
                                                <input type="date" class="form-control" name="date_fin" value="<?php echo $location['date_fin']; ?>"></input>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4">
                                                <input type="number" class="form-control" name="numero" value="<?php echo $location['numero']; ?>"></input>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" name="adresse" value="<?php echo $location['adresse']; ?>"></input>
                                            </div>
                                        </div>
                                    </div>
                                </div>
