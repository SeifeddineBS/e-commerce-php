...
$listeTrottinette = $locationc->afficherTrottinette();
            ...
            <div class="container">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="row">
                            <?php foreach ($listeTrottinette as $trottinette) { ?>
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                    <div class="single-popular-items mb-50 text-center">
                                        <div class="popular-img">
                                            <img src="assets/img/trottinette.jpg" alt="">
                                            <div class="img-cap">
                                                <?php if (isset($_GET["idlocation"])) { ?>
                                                    <a href="ajouterDetailLocation.php?idlocation=<?php echo $_GET["idlocation"]; ?>&trottinette=<?php echo $trottinette['idTrottinette']; ?>"><span>Rent</span></a>

                                                <?php } else { ?>
                                                    <a href="ajouterlocation.php?trottinette=<?php echo $trottinette['idTrottinette']; ?>"><span>Rent</span></a>
                                                <?php  } ?>
                                            </div>
                                        ...
                                        <div class="popular-caption">
                                            <h3><a href="product_details.html"> <?php echo $trottinette['modelTrottinette']; ?></a></h3>
                                            <h3><a href="product_details.html"> <?php echo $trottinette['typeTrottinette']; ?></a></h3>
                                            <span>$ 45,743</span>
                                        </div>
                                    </div>
                                </div>
