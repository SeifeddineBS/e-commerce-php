...
<body class="">
    ...
    <div class="main-panel">
        ...
        <div class="content">
                            ...
                            <div class="table-responsive">
                                <table class="table" id="table">
                                    ...
                                    <tbody id="search_result">
                                        <?php
                                        foreach ($listTrotinette as $trotti) {
                                            $imageURL = '../../image/' . $trotti["image"];
                                        ?>
                                            <tr>

                                                <td><?php echo $trotti['label']; ?></td>
                                                <td><?php echo $trotti['prix']; ?></td>
                                                ...
                                                <td><a class="btn btn-info" href="4ModifierTrotinette.php?Id=<?php echo $trotti['Id']; ?>">Edit</a>&nbsp;<a class="btn btn-danger" href="3suprimerTrotinette.php?Id=<?php echo $trotti['Id']; ?>">Delete</a></td>
            ...
            <a class="btn btn-info" href="2AjouterTrotinette.php">Ajouter une trotinette</a>
