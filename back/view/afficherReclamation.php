...
$listerep = $reclamationC->afficherrec();
?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <table class="table" border="1" align="center">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $reponse['type_reclamation']; ?></td>
                                        <td><?php echo $reponse['message']; ?></td>



                                        <?php if ($reponse['status'] == 'Non') { ?>
                                            <td>Non traitée</td>

                                        <?php } ?>
                                        <?php if ($reponse['status'] == 'Oui') { ?>
                                            <td> traitée</td>
                                        ...
                                        <?php if ($reponse['status'] == 'Non') { ?>
                                            <td>
                                                ...
                                                <form method="POST" action="traiterReclamation.php">
                                                    <button class="btn btn-primary" type="submit" name="valider">traiter</button>
