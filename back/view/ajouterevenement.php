...
if (isset($_POST["submit"])) {
    ...
    if (($_POST['titre'] != "") && ($_POST['descriprtion'] != "") && ($_POST['type'] != "") && ($_POST['lieu'] != "") && ($_POST['date'] != "") && ($_POST['image'] != "")) {
        $date = date("Y-m-d");
        $dateinput = date('Y-m-d', strtotime($_POST['date']));
        echo $date;
        if ($dateinput > $date) {
            if ($_POST['nbparticipant'] > 0) {
                ...
                $test = $evenetc->verif($evenet);
                if ($test != null) {
                    echo "<script>alert(\"cette evenement existe deja\")</script>";
                } else {
                    $evenetc->ajouterevenement($evenet);

                    echo "<script>alert(\"Evenement ajoutée avec succes\")</script>";
                    header("Location: ../view/affichierevenement.php");
                }
            } else {
                echo "<script>alert(\"verifier le nombre de participant\")</script>";
            }
        } else {
            echo "<script>alert(\"verifier la date de l'evenement\")</script>";
        }
    } else {
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="form-group">
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control" name="lieu" placeholder=""></input>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="number" class="form-control" name="nbparticipant"></input>
                                                    </div>
                                                </div>
                                            </div>
                                            <div>
